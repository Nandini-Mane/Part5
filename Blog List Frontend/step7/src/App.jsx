  ...
  return (
    <div style={blogStyle}>
      <div className="flex justify-between items-center">
        <div>
          <h3 className="inline-block font-semibold">{blog.title}</h3> by {blog.author}
        </div>
        <button
      ...
      {detailsVisible && (
        <div className="mt-4">
          ...
          <p className="mt-1">
            likes {blog.likes}
            <button className="ml-2 px-3 py-1 text-sm bg-blue-500 text-white rounded hover:bg-blue-600">
              like
            </button>
          </p>
        </div>
