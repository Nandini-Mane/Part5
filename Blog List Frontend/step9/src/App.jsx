...
const App = () => {
  ...
  const handleLike = async (blogToUpdate) => {
    ...
    // The key fix is here:
    // When we get the updated blog from the backend (or our mock service),
    // it contains the full blog object with the user information.
    // If our backend update method only returns the updated likes count,
    // we would have to merge the data ourselves.
    // Here, we simulate a backend that returns the full updated object.
